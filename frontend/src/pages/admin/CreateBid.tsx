          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Select a project to create a bid</p>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl">Create Bid</h1>
              <p className="text-gray-600 mt-1">Add a new bid for this project</p>
            </div>
          </div>
        </div>
                  ...
                  <div>
                    ...
                    <p className="mt-1">
                      {(project as any).project_type 
                        ? projectTypes.find(t => t.value === (project as any).project_type)?.label || 
                          ((project as any).project_type === 'ongoing_project' ? 'Ongoing Project' : (project as any).project_type)
                        : 'N/A'}
                    </p>
                  </div>
                  <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-2 text-gray-900">{formData.category || project.category}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-gray-900">
                      {formData.project_type 
                        ? projectTypes.find(t => t.value === formData.project_type)?.label || 
                          (formData.project_type === 'ongoing_project' ? 'Ongoing Project' : formData.project_type)
                        : projectTypes.find(t => t.value === (project as any).project_type)?.label || 
                          ((project as any).project_type === 'ongoing_project' ? 'Ongoing Project' : (project as any).project_type) || 'N/A'}
                    </p>
                  </div>
                </div>
