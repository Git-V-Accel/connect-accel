...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@website/components/ui/collapsible";
    ...
    >
      <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          <Link
            to="/login"
            className="inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors hover:text-primary focus:outline-none text-muted-foreground ml-2"
          >
            Sign In
          </Link>

          {/* Get Started Button */}
          <Button size="default" asChild className="ml-2 bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20">
      ...
      {isOpen && (
        ...
        >
          <div className="container mx-auto px-6 py-4 flex flex-col gap-2">
            ...
            {/* Auth Buttons - Mobile */}
            <div className="flex flex-col gap-2 mt-4 border-t border-border/30 pt-4">
              <Button size="default" variant="outline" asChild className="w-full">
                <Link to="/login" onClick={() => setIsOpen(false)}>
                  Sign In
                </Link>
              </Button>
              <Button size="default" asChild className="w-full bg-primary text-white">
