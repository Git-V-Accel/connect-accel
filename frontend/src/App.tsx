  ...
  return (
    <Routes>
      ...
      <Route
        path="/login"
        element={
          user ? <Navigate to={getRoleBasedRoute(user.role)} /> : <LoginPage />
        }
      />
      <Route
        path="/signup"
        element={
          user ? <Navigate to={getRoleBasedRoute(user.role)} /> : <SignupPage />
        }
      />
      ...
      />
      <Route
        path="/freelancer/projects/:projectId/detail"
        element={
          <ProtectedRoute allowedRoles={["freelancer"]}>
            <ProjectDetailPage />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/freelancer/workspace/:projectId"
        element={
          <ProtectedRoute allowedRoles={["freelancer"]}>
            <ProjectWorkspace />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/freelancer/submit-bid/:projectId"
        element={
          <ProtectedRoute allowedRoles={["freelancer"]}>
            <SubmitBid />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/freelancer/bids/:id/submit-proposal"
        element={
          <ProtectedRoute allowedRoles={["freelancer"]}>
            <SubmitProposal />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/admin/freelancers/:id/detail"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin"]}>
            <FreelancerDetail />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/admin/projects/:id/create-bid"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin"]}>
            <CreateBid />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/admin/bids/:bidId/proposal"
        element={
          <ProtectedRoute
            allowedRoles={["admin", "superadmin", "freelancer", "agent"]}
          >
            <ViewProposal />
          </ProtectedRoute>
        }
      ...
      <Route
        path="/admin/bids/:id"
        element={
          <ProtectedRoute allowedRoles={["admin", "superadmin", "agent"]}>
            <AdminBidDetail />
          </ProtectedRoute>
        }
      />
      ...
      />
      <Route
        path="/agent/projects/:id/create-bid"
        element={
          <ProtectedRoute allowedRoles={["agent"]}>
            <CreateBid />
          </ProtectedRoute>
      ...
      />
      <Route
        path="/agent/freelancers/:id"
        element={
          <ProtectedRoute allowedRoles={["agent"]}>
            <AgentFreelancerDetail />
          </ProtectedRoute>
        }
      />
      <Route
