...
export interface Project {
    ...
    status: 'draft' | 'pending' | 'pending_review' | 'active' | 'in_bidding' | 'bidding' | 'assigned' | 'in_progress' | 'completed' | 'cancelled' | 'rejected' | 'disputed' | 'open' | 'hold' | 'closed';
    category: string;
        ...
        const loadProjects = async () => {
            ...
            try {
                ...
                try {
                    ...
                    console.error('Failed to load bids:', bidError);
                }
