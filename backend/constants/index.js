...
const CLIENT_ALLOWED_TRANSITIONS = {
  [PROJECT_STATUS.DRAFT]:       [PROJECT_STATUS.ACTIVE],
  [PROJECT_STATUS.ACTIVE]:      [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  'pending_review':             [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  [PROJECT_STATUS.IN_BIDDING]:  [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  'bidding':                    [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  [PROJECT_STATUS.ASSIGNED]:    [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  [PROJECT_STATUS.IN_PROGRESS]: [PROJECT_STATUS.HOLD, PROJECT_STATUS.CANCELLED],
  [PROJECT_STATUS.HOLD]:        [PROJECT_STATUS.IN_PROGRESS, PROJECT_STATUS.ACTIVE, PROJECT_STATUS.CANCELLED],
  [PROJECT_STATUS.COMPLETED]:   [],
  [PROJECT_STATUS.CANCELLED]:   [PROJECT_STATUS.IN_PROGRESS, PROJECT_STATUS.ACTIVE]
};
